function  [n_pixels_x, n_pixels_y] = deg2pix_xy (distance_deg_x, distance_deg_y)

global SETTINGS


center_x = SETTINGS.screen_w_pix / 2;
center_y = SETTINGS.screen_h_pix /2;%*SETTINGS.screen_uh_cm/SETTINGS.screen_h_cm;
...
n_pixels_x  = round(distance_cm_x * pixels_per_cm_x);
n_pixels_y  = round(distance_cm_y * pixels_per_cm_y);
